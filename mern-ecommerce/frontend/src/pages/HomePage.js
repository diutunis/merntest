...
const HomePage = () => {
    ...
    const [touchStart, setTouchStart] = useState(null); // Track touch start for pinch-to-zoom
    ...
    const handleTouchMove = (event) => {
        if (event.touches.length === 2 && touchStart) {
            ...
            const scaleFactor = distanceMove / distanceStart;
